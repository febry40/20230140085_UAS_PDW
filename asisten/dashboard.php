...
<div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4 hover:bg-blue-50 transition">
    <div class="bg-indigo-100 p-3 rounded-full">
        <svg class="w-6 h-6 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 6.75L19.5 6.75M4.5 12L19.5 12M4.5 17.25L19.5 17.25" />
        </svg>
    </div>
    <div>
        <a href="/SistemPengumpulanTugas-main/praktikumAsisten/index.php" 
        class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
        Kelola Mata Praktikum
        </a>
        <p class="text-sm text-gray-500">Tambah/Edit daftar praktikum</p>
    </div>
</div>
